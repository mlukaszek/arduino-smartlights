...
/* a0p3 */ przycisk_pietro_hol_pojedynczy,
...
/* a2p3 */ przycisk_parter_kuchnia_okap_lewy,
/* a2p4 */ przycisk_parter_kuchnia_okap_prawy,
/* a2p5 */ przycisk_parter_gabinet,
...
/* a2p3 */ punkt_parter_gabinet_sufit,
...
const PROGMEM unsigned char rules[] = {
 ...
 WHEN_PRESSED_SHORT(parter_kuchnia_scianka_prawy), TOGGLE(parter_kuchnia_blat),
 ...
 WHEN_PRESSED_MEDIUM(pietro_hol_podwojny_lewy), TOGGLE(pietro_hol_sufit),
 WHEN_PRESSED_SHORT(pietro_hol_podwojny_lewy), TIMER_RESET(pietro_schody),
 WHEN_PRESSED_SHORT(pietro_hol_podwojny_prawy), TOGGLE(pietro_hol_kinkiet),
 ...
 WHEN_PRESSED_SHORT(parter_kuchnia_okap_lewy), TOGGLE(parter_kuchnia_podwieszany),
 WHEN_PRESSED_SHORT(parter_kuchnia_okap_prawy), TOGGLE(parter_kuchnia_blat),
 ...
 WHEN_PRESSED_MEDIUM(parter_schody), TOGGLE(pietro_hol_sufit),
 WHEN_PRESSED_SHORT(parter_schody), TIMER_RESET(pietro_schody),
 ...
 WHEN_PRESSED_SHORT(pietro_hol_pojedynczy), TOGGLE(pietro_hol_sufit),
 ...
 WHEN_PRESSED_MEDIUM(parter_naroznik), TOGGLE(parter_salon_sufit),
 WHEN_PRESSED_SHORT(parter_naroznik), TOGGLE(parter_salon_podwieszany),
