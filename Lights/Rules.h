...
constexpr PROGMEM unsigned char rules[] = {
 ...
 WHEN_PRESSED_MEDIUM(piwnica_wejscie_lewy), TOGGLE(piwnica_warsztat),
 WHEN_PRESSED_SHORT(piwnica_wejscie_lewy), TOGGLE(piwnica_hol),
 WHEN_PRESSED_MEDIUM(piwnica_wejscie_srodkowy), TOGGLE(piwnica_kotlownia),
 WHEN_PRESSED_SHORT(piwnica_wejscie_srodkowy), TOGGLE(piwnica_schody),
 WHEN_PRESSED_MEDIUM(piwnica_wejscie_prawy), TOGGLE(piwnica_sala),
